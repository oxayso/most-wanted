describe('getPerson', function(){
  ...
  it('Jasmine Bob', function() {
    ...
    expect(getPerson("Jasmine", "Bob", people)).toEqual([jasmine]);
  });
});
 ...
 describe('getKids', function(){
  ...
  it('kids', function() {
    ...
    expect(getKids(parent, people)).toEqual(kids);
  });
});
...
describe('getNames', function(){
  beforeEach(function(){
  selectedPeople = [{id:272822514,firstName:"Billy",lastName:"Bob",gender:"male",dob:"1/18/1949",height:71,weight:175,eyeColor:"brown",occupation:"programmer",parents:[],currentSpouse:401222887},{id:401222887,firstName:"Uma",lastName:"Bob",gender:"female",dob:"4/1/1947",height:65,weight:162,eyeColor:"brown",occupation:"assistant",parents:[],currentSpouse:272822514},{id:409574486,firstName:"Michael",lastName:"Walkens",gender:"male",dob:"5/9/1951",height:76,weight:250,eyeColor:"brown",occupation:"landscaper",parents:[],currentSpouse:260451248}];
    });
    it('Array of people', function(){
      var names = selectedPeople[0].firstName + " " + selectedPeople[0].lastName +
      ", " + selectedPeople[1].firstName + " " + selectedPeople[1].lastName +
      ", and " + selectedPeople[2].firstName + " " + selectedPeople[2].lastName

      expect(getNames(selectedPeople)).toEqual(names);
    });
});
